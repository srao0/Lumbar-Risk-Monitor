...
On an unseen participant's conforming sessions the reduced two-IMU model is the strongest route, consistent with the Phase II.A deployment recommendation, and the reduced set beats the full-hybrid route here too.
