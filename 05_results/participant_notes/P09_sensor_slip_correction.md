...
> **Canonical numbers:** this note documents the sensor-slip *correction decision*; its per-participant AUCs predate the drift-correction and QC re-freeze. The authoritative frozen figures are in `../frozen_numbers/frozen_numbers_sheet.md`.
...
- **CLEAN_LATERAL and CLEAN_ROTATION show PL_roll 45–47°** post-correction, which is plausible for active lateral movement but also picks up the slip-residual.
...
## 8. What the correction did and did not do
