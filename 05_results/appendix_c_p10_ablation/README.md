...
So adding P10's augmented windows nudges the primary set up slightly and the reduced set down slightly, both within noise. P10 augmentation is not worth including, and the exclusion stands. Figure `C2_p10_augmentation_delta_auc.png`; table in `p10_ablation_table.csv` / `.tex`.
